package com.example.buttoon.bean;
...
public class ZhuantiBean {
    ...
    public static class DataDTO {
        ...
        public List<DataDTOO> getData() {
            return data;
        }

        public void setData(List<DataDTOO> data) {
            this.data = data;
        }

        public static class DataDTOO {
            /**
             * id : 314
             * title : 关爱他成长的每一个足迹
             * price_info : 0
